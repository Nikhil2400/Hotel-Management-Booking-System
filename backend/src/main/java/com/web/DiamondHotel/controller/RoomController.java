package com.web.DiamondHotel.controller;
...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(
        ...
        System.out.println("Adding new room with the following details: " +
                "photo=" + (photo != null ? photo.getOriginalFilename() : "No Photo") +
                ", roomType=" + roomType +
                ", roomPrice=" + roomPrice +
